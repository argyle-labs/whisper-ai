...
Whisper speech-to-text (Wyoming/ASR) — a first-party [orca](https://github.com/argyle-labs/orca) **service-backend**
...
`deploy`, `backup`, `restore`, `configure`, `status`. Rich, whisper-ai-specific data is
